...
import com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServer;
...
class RegisteredServerImpl extends CreatableUpdatableImpl<RegisteredServer, RegisteredServerInner, RegisteredServerImpl> implements RegisteredServer, RegisteredServer.Definition, RegisteredServer.Update {
    ...
    public Observable<RegisteredServer> createResourceAsync() {
        ...
        return client.createAsync(this.resourceGroupName, this.storageSyncServiceName, this.serverId, this.inner())
    ...
    public Integer serverManagementtErrorCode() {
        return this.inner().serverManagementtErrorCode();
    }
    ...
    public RegisteredServerImpl withClusterId(String clusterId) {
        this.inner().withClusterId(clusterId);
        return this;
    }

    @Override
    public RegisteredServerImpl withClusterName(String clusterName) {
        this.inner().withClusterName(clusterName);
        return this;
    }

    @Override
    public RegisteredServerImpl withDiscoveryEndpointUri(String discoveryEndpointUri) {
        this.inner().withDiscoveryEndpointUri(discoveryEndpointUri);
        return this;
    }
    ...
    public RegisteredServerImpl withLastHeartBeat(String lastHeartBeat) {
        this.inner().withLastHeartBeat(lastHeartBeat);
        return this;
    }

    @Override
    public RegisteredServerImpl withLastOperationName(String lastOperationName) {
        this.inner().withLastOperationName(lastOperationName);
        return this;
    }

    @Override
    public RegisteredServerImpl withLastWorkflowId(String lastWorkflowId) {
        this.inner().withLastWorkflowId(lastWorkflowId);
        return this;
    }

    @Override
    public RegisteredServerImpl withManagementEndpointUri(String managementEndpointUri) {
        this.inner().withManagementEndpointUri(managementEndpointUri);
        return this;
    }

    @Override
    public RegisteredServerImpl withProvisioningState(String provisioningState) {
        this.inner().withProvisioningState(provisioningState);
        return this;
    }

    @Override
    public RegisteredServerImpl withResourceLocation(String resourceLocation) {
        this.inner().withResourceLocation(resourceLocation);
        return this;
    }

    @Override
    public RegisteredServerImpl withServerCertificate(String serverCertificate) {
        this.inner().withServerCertificate(serverCertificate);
        return this;
    }

    @Override
    public RegisteredServerImpl withServerId(String serverId) {
        this.inner().withServerId(serverId);
        return this;
    }

    @Override
    public RegisteredServerImpl withServerManagementtErrorCode(Integer serverManagementtErrorCode) {
        this.inner().withServerManagementtErrorCode(serverManagementtErrorCode);
        return this;
    }

    @Override
    public RegisteredServerImpl withServerOSVersion(String serverOSVersion) {
        this.inner().withServerOSVersion(serverOSVersion);
        return this;
    }

    @Override
    public RegisteredServerImpl withServerRole(String serverRole) {
        this.inner().withServerRole(serverRole);
        return this;
    }

    @Override
    public RegisteredServerImpl withServiceLocation(String serviceLocation) {
        this.inner().withServiceLocation(serviceLocation);
        return this;
    }

    @Override
    public RegisteredServerImpl withStorageSyncServiceUid(String storageSyncServiceUid) {
        this.inner().withStorageSyncServiceUid(storageSyncServiceUid);
        return this;
    }
