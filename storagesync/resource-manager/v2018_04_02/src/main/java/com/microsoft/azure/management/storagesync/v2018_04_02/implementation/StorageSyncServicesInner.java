...
import com.microsoft.azure.management.storagesync.v2018_04_02.CheckNameAvailabilityParameters;
import com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncErrorException;
import com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServicesDeleteHeaders;
import com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServicesGetHeaders;
import com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServicesListByResourceGroupHeaders;
import com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServicesListBySubscriptionHeaders;
import com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServicesUpdateHeaders;
...
public class StorageSyncServicesInner implements InnerSupportsGet<StorageSyncServiceInner>, InnerSupportsDelete<Void>, InnerSupportsListing<StorageSyncServiceInner> {
    ...
    interface StorageSyncServicesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServices checkNameAvailability" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServices create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServices getByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServices update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServices delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServices listByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.StorageSyncServices list" })
        ...
        return service.listByResourceGroup(this.client.subscriptionId(), resourceGroupName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<List<StorageSyncServiceInner>, StorageSyncServicesListByResourceGroupHeaders>>>() {
                ...
                public Observable<ServiceResponseWithHeaders<List<StorageSyncServiceInner>, StorageSyncServicesListByResourceGroupHeaders>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<PageImpl1<StorageSyncServiceInner>, StorageSyncServicesListByResourceGroupHeaders> result = listByResourceGroupDelegate(response);
                        List<StorageSyncServiceInner> items = null;
                        if (result.body() != null) {
                            items = result.body().items();
                        }
                        ServiceResponseWithHeaders<List<StorageSyncServiceInner>, StorageSyncServicesListByResourceGroupHeaders> clientResponse = new ServiceResponseWithHeaders<>(items, result.headers(), result.response());
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
        ...
        return service.list(this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<List<StorageSyncServiceInner>, StorageSyncServicesListBySubscriptionHeaders>>>() {
                ...
                public Observable<ServiceResponseWithHeaders<List<StorageSyncServiceInner>, StorageSyncServicesListBySubscriptionHeaders>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<PageImpl1<StorageSyncServiceInner>, StorageSyncServicesListBySubscriptionHeaders> result = listDelegate(response);
                        List<StorageSyncServiceInner> items = null;
                        if (result.body() != null) {
                            items = result.body().items();
                        }
                        //
                        ServiceResponseWithHeaders<List<StorageSyncServiceInner>, StorageSyncServicesListBySubscriptionHeaders> clientResponse = new ServiceResponseWithHeaders<>(items, result.headers(), result.response());
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
