...
public class StorageSyncErrorException extends RestException {
     ...
     */
    public StorageSyncErrorException(final String message, final Response<ResponseBody> response) {
     ...
     */
    public StorageSyncErrorException(final String message, final Response<ResponseBody> response, final StorageSyncError body) {
