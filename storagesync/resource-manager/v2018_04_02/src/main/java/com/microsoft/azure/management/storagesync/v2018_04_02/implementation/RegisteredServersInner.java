...
import com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServersCreateHeaders;
import com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServersDeleteHeaders;
import com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServersGetHeaders;
import com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServersListByStorageSyncServiceHeaders;
...
public class RegisteredServersInner {
    ...
    interface RegisteredServersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServers listByStorageSyncService" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServers get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServers create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServers beginCreate" })
        @PUT("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/registeredServers/{serverId}")
        Observable<Response<ResponseBody>> beginCreate(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("storageSyncServiceName") String storageSyncServiceName, @Path("serverId") String serverId, @Query("api-version") String apiVersion, @Body RegisteredServerInner parameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServers delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagesync.v2018_04_02.RegisteredServers beginDelete" })
        @HTTP(path = "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/registeredServers/{serverId}", method = "DELETE", hasBody = true)
        ...
        return service.listByStorageSyncService(this.client.subscriptionId(), resourceGroupName, storageSyncServiceName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<List<RegisteredServerInner>, RegisteredServersListByStorageSyncServiceHeaders>>>() {
                ...
                public Observable<ServiceResponseWithHeaders<List<RegisteredServerInner>, RegisteredServersListByStorageSyncServiceHeaders>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<PageImpl1<RegisteredServerInner>, RegisteredServersListByStorageSyncServiceHeaders> result = listByStorageSyncServiceDelegate(response);
                        List<RegisteredServerInner> items = null;
                        if (result.body() != null) {
                            items = result.body().items();
                        }
                        ServiceResponseWithHeaders<List<RegisteredServerInner>, RegisteredServersListByStorageSyncServiceHeaders> clientResponse = new ServiceResponseWithHeaders<>(items, result.headers(), result.response());
